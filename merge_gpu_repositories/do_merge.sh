...
# For completeness...
# Commenting out because the repo now exists and we don't want to do this anymore.
# git remote remove $FGPU_NAME
# git remote remove $XGPU_NAME
# git remote add origin git@github.com:ska-sa/$COMMON_NAME.git
# git push --set-upstream origin main
# git checkout prebeamformer_reorder
# git push --set-upstream origin prebeamformer_reorder
